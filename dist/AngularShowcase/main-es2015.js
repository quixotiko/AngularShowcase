...
let InfiniteScrollComponent = class InfiniteScrollComponent {
    constructor() {
        this.cache = [];
        this.itemHeight = 100;
        ...
        this.pageByScroll$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["fromEvent"])(window, "scroll")
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(() => window.scrollY), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(() => {
            // console.log(this.scrollArea.clientHeight);
            // console.log(window.innerHeight);
            // console.log(window.scrollY);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])((y) => y >= this.scrollArea.clientHeight - window.innerHeight), //这里不是body.clientHeight!!
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinct"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["debounceTime"])(200), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((y) => {
        ...
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinct"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])((page) => this.cache[page - 1] === undefined));
        this.itemResults$ = this.pageToLoad$
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((page) => {
            this.loading = true;
            console.log(page);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["flatMap"])((page) => {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["range"])((page - 1) * 10 + 1, 10).pipe(//range第二个参数是个数
            Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((n) => {
                return {
                    index: n,
                    bgColor: 'rgb(' + Math.random() * 255 + ',' + Math.random() * 255 + ',' + Math.random() * 255 + ')'
                };
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["toArray"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["delay"])(1000), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((array) => {
                console.log(array);
        ...
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(() => lodash__WEBPACK_IMPORTED_MODULE_4__["flatten"](this.cache)));
    }
    ngOnInit() {
...
let MousemoveEffectComponent = class MousemoveEffectComponent {
    constructor() { }
    ngOnInit() {
    }
};
